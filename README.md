...
| | | [SearchTest](./src/p7/SearchTest.java) | Compares the performance of brute force and KMP substring search algorithms, using data from the [input file](./src/p7/input.txt). 
...
| 10| [Assignment: Huffman Compression](src/a1) | [Huffman](./src/a1/Huffman.java) | Compresses or decompresses files (provided as command line arguments) using the Huffman coding algorithm.
